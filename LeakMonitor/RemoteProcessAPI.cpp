...
///
/// Some of the following functions are copied and slightly modified
/// from 'Mr Nukealizer @ codeproject.com'.
/// https://www.codeproject.com/tips/139349/getting-the-address-of-a-function-in-a-dll-loaded
/// 
/// The code was licensed as CPOL 1.02
/// https://www.codeproject.com/info/cpol10.aspx
///

/// Returns a remote module handle from a given process.
HMODULE WINAPI GetRemoteModuleHandle(HANDLE hProcess, LPCSTR lpModuleName)
{
   ...
   for (size_t i = 0; lpModuleName[i] != '\0'; ++i)
      lpModuleNameCopy[i] = std::tolower (lpModuleName[i]);
   ...
   for (DWORD i = 0; i <= NumModules; ++i)
   {
      ...
      for (size_t j = 0; ModuleNameBuffer[j] != '\0'; ++j)
         ModuleNameBuffer[j] = std::tolower (ModuleNameBuffer[j]);
...
/// Returns a proc address from a given process.
